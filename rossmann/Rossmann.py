...
class Rossmann(object):
    ...
    def feature_engineering(self, df2):
        ...
        # Identificado algumas variáveis como 'int32', sendo necessário ajustar o tipo desses dados
        df2['year'] = df2['year'].astype('int64')
        df2['month'] = df2['month'].astype('int64')
        df2['day'] = df2['day'].astype('int64')
        df2['week_of_year'] = df2['week_of_year'].astype('int64')
        df2['competition_time_month'] = df2['competition_time_month'].astype(
            'int64')
    ...
    def data_preparation(self, df5):
        ...
        # Variáveis de Natureza Ciclica (se repetem):
        ...
        cols_selected = ['store', 'promo', 'store_type', 'assortment', 'competition_distance', 'competition_open_since_month', 'competition_open_since_year', 'promo2',
                         'promo2_since_week', 'promo2_since_year', 'competition_time_month', 'promo_time_week', 'month_cos', 'month_sin', 'day_sin', 'day_cos', 'week_of_year_cos',
    ...
    def get_prediction(self, model, original_data, test_data):
        ...
        # join pred into the orginal data
